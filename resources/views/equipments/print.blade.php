                    ...
                    <div class="column">
                        ...
                        <section class="mrt-card">
                            <div class="mrt-card-id">
                                <p class="line1">{{ $company }}</p>
                                <p>ACCOUNT NUMBER: {{ substr($equipment['point_id'], 0, -4) }}</p>
                            </div>
                            ...
                            <div class="mrt-card-brand">
                                ...
                                <div class="mrt-sample">
                                    <p>SAMPLE POINT ID:{{ substr($equipment['point_id'], 7) }}</p>
                                </div>
                            </div>
                            ...
                            <div class="mrt-card-detail">
                                ...
                                <div class="qr-img">
                                    {!! QrCode::size(90)->generate($equipment['point_id']) !!}
                                </div>
                            </div>
